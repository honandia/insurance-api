...
namespace SimpleTokenProvider
{
    ...
    public class TokenProviderMiddleware
    {
        ...
        private async Task GenerateToken(HttpContext context)
        {
            ...
            var clients = HttpHelper.GetMockClientsDataAsync().Result;
            var role = clients.clients.Find(c => c.name.Equals(username) && c.email.Equals(password)).role;
        ...
        {
            var clients = HttpHelper.GetMockClientsDataAsync().Result;
            var loggedIn = clients.clients.Exists(c => c.name.Equals(username) && c.email.Equals(password));
